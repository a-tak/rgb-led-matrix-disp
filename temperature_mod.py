...
class TemperatureSensor():
    ...
    def get(self):
        ...
        """
        logger.debug("Temperture Module Start")
    ...
    def readData(self):
        ...
        #named tuple
        SenserValue = namedtuple('SenserValue','temp hpa hum')

        return SenserValue(self.compensate_T(temp_raw), self.compensate_P(pres_raw), self.compensate_H(hum_raw))
